...
return [
    ...
    'buy_ctt' => 'Buy CTT',
    'ctt_is' => 'Cashtree is the largest mobile advertising platform in Indonesia. Starting in 2022, Cashtree is adopting the blockchain technology and cryptocurrency to provide transparency to both Cashtree users and advertisers. Cashtree is building the ecosystem to grant our users a reward to step into the new world of cryptocurrency.',
    'ln_mr' => 'Learn More',
    'ln_ls' => 'Learn Less',
    'the_gate' =>  'The Gate of Crypto',
    'adoption' => 'Adoption in Indonesia',
    'ct_bv' => 'Cashtree believes that the world is vastly changing, and part of it is the blockchain that has taken over the financial industry by storm. Unfortunately, blockchain is still not widely or systematically understood. Many people in Indonesia either do not realize exactly how blockchain can help them, or do not understand how start entering the crypto world.',
    'through' => 'Through the Cashtree blockchain project,',
    'be_gate' => 'Cashtree is committed to be the “gate” for crypto adoption in Indonesia.',
    'what_is' => 'What is :',
    'ctoken_ctt' => 'Cashtree Token ‘CTT’',
    'ctt_new' => 'Cashtree Token (CTT) is the newly introduced incentives for users inside of the Cashtree app and Cashtree Business Ecosystem. Cashtree Token will be used along with Cashtree Poin ; our current incentives for users inside of Cashtree apps that can be exchanged with various rewards inside of Cashtree apps; 
                during early transition time, and later on will be fully implemented as the sole reward inside of Cashtree. 
                Aligned with Cashtree’s mission to be the "gate" of the Crypto adoption in Indonesia, we also want to bring the benefits of crypto and embody the democratization of the economy for all of our users. 
                The Cashtree Token (CTT) implementation will introduce the various utilities and bring tons of benefits for Cashtree users.',
    'how_to' => 'How to earn CTT',
    ...
    'ctt_can' => 'Cashtree Token (CTT) can also be acquired by buying the CTT on crypto exchanges that list Cashtree Token (CTT). Cashtree is aiming to be listed on official exchanges in Indonesia by the end of 2022.',
    'utility' => 'CTT Utility',
    'team' => 'CTT Team',
    ...
    't_airdrop3' => 'Cashtree is the largest mobile entertainment and advertising platform in Indonesia, which has been operating since 2016. Cashtree has been known as the most reliable platform for brands and advertisers to carry out various digital marketing campaigns, and as a platform that provides various attractive prizes for its users. Since its release in 2016, until the end of 2022 Cashtree has had 20 million users, with an average MAU of 300,000. At the moment, the Cashtree App is only available for Indonesian users. However, Cashtree will open its app for global users very soon. So, stay tune!',
    't_airdrop4' => 'Cashtree connects brands with users in a fair reciprocal relationship, where brands and advertisers will get conversions as a result of their advertising campaigns, and users get reciprocity in the form of prizes for their participation with ad campaigns from advertisers. ',
    't_airdrop5' => 'Cashtree Token Project is a solution that Cashtree offers to support transparency in campaign performance for clients, provide incentives that have economic value and can support the needs of Cashtree users and the community, and support the adoption of crypto and blockchain technology in Indonesia and the world. This Cashtree token is essentially an initial capital for users who are entering the crypto world for the first time.',
    't_airdrop6' => 'Step by Step Guide for joining the Cashtree Token Airdrop :',
    't_airdrop7' => 'Via Cashtree App (for Indonesian user only at the moment)',
    't_airdrop8' => 'Install Cashtree app from Google Playstore',
    't_airdrop9' => 'Follow the Airdrop Mission',
    't_airdrop10' => 'Via Cashtree Token website',
    't_airdrop11' => 'Go to Gleams Cashtree Token Airdrop Mission',
    't_airdrop12' => 'Don’t forget to follow Cashtree Token on Twitter, and join Cashtree Token Telegram Group and Discord to stay up to date on the Airdrop announcements.',
    't_airdrop13' => 'Good luck and have fun!',
    't_airdrop14' => 'Disclaimer : This content is not intended to provide financial advice. The information provided in this content is for educational and informational purposes only and should not be considered as a substitute for professional financial advice. Investors should conduct their own research and analysis before making any investment decisions. Cryptocurrency investment is a high-risk investment and may result in significant financial loss. Therefore, investors should carefully consider their investment objectives, risk tolerance, and financial situation before investing in any cryptocurrency. The author of this content shall not be held responsible for any losses, damages, or expenses incurred by any person or entity as a result of the information provided in this content.',
